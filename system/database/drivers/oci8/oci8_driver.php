...
class CI_DB_oci8_driver extends CI_DB {
	 ...
	 * @return array params array keys
	 *        
	 *         KEY OPTIONAL	NOTES
	 *         name		no		the name of the parameter should be in :<param_name>
	 *         format
	 *         value	no		the value of the parameter. If this is an OUT or IN OUT
	 *         parameter,
	...
	public function trans_begin($test_mode = FALSE) {
		...
		// If the $test_mode flag is set to TRUE transactions will be rolled
		// back
	 ...
	 *       	 string
	 * @param
	 *       	 bool	whether or not the string will be used in a LIKE
	 *        	condition
	 * @return string
	 */
	 ...
	 * Show table query
	 *
	 * Generates a platform-specific query string so that the table names can be
	 * fetched
	 *
	 * @access protected
	 * @param
	 ...
	 * Show column query
	 *
	 * Generates a platform-specific query string so that the column names can
	 * be fetched
	 *
	 * @access protected
	 * @param
	 ...
	 * Field data query
	 *
	 * Generates a platform-specific query so that the column data can be
	 * retrieved
	 *
	 * @access public
	 * @param
