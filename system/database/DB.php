...
function &DB($params = '', $active_record_override = NULL) {
	...
	if (is_string ( $params ) and strpos ( $params, '://' ) === FALSE) {
		...
		/*
		 * parse the URL from the DSN string Database settings can be passed as
		 * discreet parameters or as a data source name in the first parameter.
		 * DSNs must have this prototype: $dsn =
