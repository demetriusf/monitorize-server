...
class CI_Migration {
	 ...
	 * @return mixed if already latest, FALSE if failed, int if upgraded
	 */
	 ...
	 *
	 * @return mixed if already current, false if failed, int if upgraded
	 */
	 ...
	 * Error string
	 *
	 * @return string message returned as a string
	 */
	 ...
	 *
	 * @param
	 *       	 int	Migration reached
	 * @return bool
	 */
	protected function _update_version($migrations) {
		return $this->db->update ( 'migrations', array ('version' => $migrations ) );
	}
