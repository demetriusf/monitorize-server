...
class CI_Profiler {
	...
	protected $_available_sections = array ('benchmarks', 'get', 'memory_usage', 'post', 'uri_string', 'controller_info', 'queries', 'http_headers', 'session_data', 'config' );
	 ...
	 * Set Sections
	 *
	 * Sets the private _compile_* properties to enable/disable Profiler
	 * sections
	 *
	 * @param
	 *       	 mixed
	...
	protected function _compile_benchmarks() {
		...
		// be modified. We also might want to make this data available to be
		// logged
