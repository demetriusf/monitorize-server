...
class CI_Table {
	...
	/**
	 * Set columns.
	 * Takes a one-dimensional array as input and creates
	...
	function _prep_args($args) {
		...
		// This can happen if there is only a single key, for example this is
		// passed to table->generate
		// array(array('foo'=>'bar'))
	...
	function generate($table_data = NULL) {
		...
		// set a custom cell manipulation function to a locally scoped variable
		// so its callable
	...
	function _set_from_array($data, $set_heading = TRUE) {
		...
		$i = 0;
		foreach ( $data as $row ) {
			// If a heading hasn't already been set we'll use the first row of
			// the array as the heading
	...
	function _default_template() {
		...
		'heading_row_start' => '<tr>', 'heading_row_end' => '</tr>', 'heading_cell_start' => '<th>', 'heading_cell_end' => '</th>', 

		'tbody_open' => '<tbody>', 'tbody_close' => '</tbody>', 
