...
class CI_Jquery extends CI_Javascript {
	 ...
	 *       	 string	- element
	 * @param
	 *       	 string	- One of 'slow', 'normal', 'fast', or time in
	 *        	milliseconds
	 * @param
	...
	function _updater($container = 'this', $controller, $options = '') {
		...
		// ajaxStart and ajaxStop are better choices here... but this is a stop
		// gap
	 ...
	 * Add Event
	 *
	 * Constructs the syntax for an event, and adds to into the array for
	 * compilation
	 *
	 * @access private
	 * @param
	 ...
	 * Script Tag
	 *
	 * Outputs the script tag that loads the jquery.js file into an HTML
	 * document
	 *
	 * @access public
	 * @param
