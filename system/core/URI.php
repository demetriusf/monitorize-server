...
class CI_URI {
	...
	function _fetch_uri_string() {
		if (strtoupper ( $this->config->item ( 'uri_protocol' ) ) == 'AUTO') {
			...
			// Let's try the REQUEST_URI first, this will work in most
			// situations
			...
			// Note: some servers seem to have trouble with getenv() so we'll
			// test it two ways
	...
	function _filter_uri($str) {
		if ($str != '' && $this->config->item ( 'permitted_uri_chars' ) != '' && $this->config->item ( 'enable_query_strings' ) == FALSE) {
			...
			// compatibility as many are unaware of how characters in the
	 ...
	 *
	 * This function returns the re-routed URI segment (assuming routing rules
	 * are used)
	 * based on the number provided. If there is no routing this function
	 * returns the
