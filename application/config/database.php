 ...
 * the database |	['swap_pre'] A default table prefix that should be swapped
 * with the dbprefix |	['autoinit'] Whether or not to automatically initialize
 * the database. |	['stricton'] TRUE/FALSE - forces 'Strict Mode' connections
 * |							- good for ensuring strict SQL while developing | | The $active_group
 * variable lets you choose which connection group to | make active. By default
 * there is only one group (the 'default' group). | | The $active_record
 * variables lets you determine whether or not to load | the active record class
 */
